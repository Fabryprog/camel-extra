...
public class RCodeProducerVoidEvalTest extends RCodeProducerTest {
    ...
    private final String path = RCodeProducerVoidEvalTest.class.getProtectionDomain().getCodeSource().getLocation().getPath() + "/german_map.pdf";
    ...
    public void sendVoidEvalCmdMapTest() throws Exception {
        ...
        mockEndpoint.expectedBodiesReceived(obj); // void_eval returns a body
                                                  // with null value
    ...
    public void sendVoidEvalCmdHeaderTest() throws Exception {
        ...
        template.sendBodyAndHeader("direct:rcode", command, RCodeConstants.RSERVE_OPERATION, RCodeOperation.VOID_EVAL);
        mockEndpoint.assertIsSatisfied();
    }
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {
            ...
            public void configure() throws Exception {
                ...
                from("direct:rcode").to("rcode:localhost:6311/void_eval?user=test&password=test123").to("mock:rcode");
            }
        };
    }
}
