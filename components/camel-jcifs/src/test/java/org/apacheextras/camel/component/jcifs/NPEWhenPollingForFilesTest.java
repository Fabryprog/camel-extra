...
/**
 * Unit test to verify behaviour of NPE when it is not from
 * jcifs.smb.Dfs.resolve
 */
public class NPEWhenPollingForFilesTest extends BaseSmbTestSupport {
    ...
    public void setUpFileSystem() throws Exception {
        ...
        expect(rootDir.listFiles()).andThrow(new NullPointerException("Fake NPE!"));
        expect(rootDir.listFiles()).andReturn(new SmbFile[] {sourceFile});
